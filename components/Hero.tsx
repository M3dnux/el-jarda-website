        ...
        >
          ...
          <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center ${language === 'ar' ? 'sm:flex-row-reverse' : ''}`}>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`btn-primary text-lg px-8 py-4 ${language === 'ar' ? 'arabic-text' : ''}`}
            ...
            <motion.a
              ...
              className={`btn-secondary text-lg px-8 py-4 flex items-center ${language === 'ar' ? 'gap-2 flex-row-reverse arabic-text' : 'gap-2'}`}
            >
